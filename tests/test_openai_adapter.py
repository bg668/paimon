...
from paimonsdk.adapters import OpenAIChatCompletionsAdapter, OpenAIRequestConfig
from paimonsdk.runtime.config import AgentLoopConfig
from paimonsdk.runtime.models import AgentContext, ModelInfo, TextContent, ToolCallContent, UserMessage
...
def test_openai_adapter_request_config_owns_provider_specific_options():
    async def _run() -> None:
        response = SimpleNamespace(
            id="chatcmpl_1",
            model="gpt-4o-mini",
